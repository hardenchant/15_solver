...
Я пока этим не занимался, но здесь должно быть что то [такое](https://www.cs.princeton.edu/courses/archive/fall12/cos226/assignments/8puzzle.html) (годная ссылка по теме). И, может, какие то умные слова про чётное и нечётное число инверсий.
